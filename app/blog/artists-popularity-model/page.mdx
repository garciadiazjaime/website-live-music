...
Feel free to visit [Is my Twitter popular?](https://www.chicagomusiccompass.com/), to compare your twitter account with the artists. This utilizes the same regression model trained here.
</article>
</section>
